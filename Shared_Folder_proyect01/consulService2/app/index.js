  ...
  res.send(`
    <html>
      <body>
        ...
        <p>data_host: ${HOST}</p>
        <p>data_nodo: <span style="color:blue; font-weight:bold; font-size:24px">${NODO.toUpperCase()}</span></p>
        <p>data_puerto: <span style="color:blue; font-weight:bold; font-size:24px">${PUERTO.toString().toUpperCase()}</span></p>
      </body>
    </html>
  `);
});
